...
STATIC_ASSETS = {
    ...
    "/attachment_state.js": ("attachment_state.js", "text/javascript; charset=utf-8"),
...
class _Handler(BaseHTTPRequestHandler):
    ...
    def _write_stream_event(self, event: Any) -> None:
        ...
        if event.source_diagnostics is not None:
            body["source_diagnostics"] = event.source_diagnostics
